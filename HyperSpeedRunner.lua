...
mainFrame.Draggable = true -- Nota: Draggable está depreciado, mas funciona. Implementaremos um drag manual melhor abaixo.
...
numberInput.Size = UDim2.new(0, 160, 0, 40)
...
destroyBtn.Size = UDim2.new(0, 160, 0, 40)
...
-- Loop do Farm (Executa o RemoteEvent)
task.spawn(function()
	while true do
		if farmActive then
		...
		task.wait(0.1) -- Ajuste o delay conforme necessário
	end
end)
...
minBtn.MouseButton1Click:Connect(function()
	...
	if isMinimized then
		...
		mainFrame:TweenSize(UDim2.new(0, 200, 0, 250), "Out", "Quad", 0.3, true, function()
